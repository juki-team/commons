import { ProblemInput, ProblemOutput, type ProblemRole, ProblemScoringMode, ProblemType, Role } from '../enums/index.js';
...
export const PROBLEM_MODE: {
  ...
  [ProblemScoringMode.TOTAL]: {
    ...
    label: 'total',
    description:
      'if all test cases are Accepted the result is Accepted ' +
  ...
  [ProblemScoringMode.SUBTASK]: {
    ...
    label: 'subtask',
    description:
      'the test cases are grouped and each group of test cases is assigned a score, ' +
  ...
  [ProblemScoringMode.PARTIAL]: {
    ...
    label: 'partial',
    description:
      'the test cases are grouped and each group is associated with X points, ' +
...
export const PROBLEM_TYPE: { [Key in ProblemType]: { value: ProblemType; label: string; description: string } } = {
  [ProblemType.STANDARD]: {
    ...
    label: 'standard',
    description:
      'The contestant submit a single source code in one of the allowed programming languages. ' +
